...
def progress_to_plat(csv_path, fig_path):
    ...
    df[['num_episodes', 'train_rewards', 'observation_loss', 'kl_loss', 'reward_loss']].plot.line(x='num_episodes', subplots=True, layout=(2, 2), figsize=(9, 6))
    # plt.show()
...
if __name__ == '__main__':
    ...
    csv_path = args.data
    fig_path = args.fig
    progress_to_plat(csv_path, fig_path)
